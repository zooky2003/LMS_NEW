...
-- PHP Version: 8.0.26
-- CORRECTED VERSION: Added missing status column to enrollments table
...
-- CORRECTED: Added missing status column
--
...
INSERT INTO `enrollments` (`id`, `user_id`, `class_id`, `enrollment_date`, `status`) VALUES
(1, 1, 1, '2025-09-13 19:48:20', 'Active'),
(2, 1, 2, '2025-09-13 20:38:20', 'Active');
